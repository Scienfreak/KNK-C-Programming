...
/* * * * * * * * * * * * * * * * * * * * * * *
 * main: Call read_cards, ananlyze_hand, and *
 ...
 *              num_in_rank, num_in_suit; checks for         *
...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 *  analyze_cards: Determines whether the hand cntains       *
...
void analyze_hand(void) {
    ...
    for (; rank < NUM_RANKS && num_in_rank[rank] > 0; rank++)
        num_consec++;
    if (num_consec == NUM_CARDS) straight = true;
    else if (num_consec == NUM_CARDS - 1 &&
             num_in_rank[NUM_RANKS - 1] == 1 &&
             num_in_rank[0] == 1) straight = true;
    else
        ;
